#!/usr/bin/env python3
"""Generate ORCA jobs for the last 100 H2-formation training clusters.
...
Submit from this folder:
    for f in r09_hot_w_h2training_last100_*.slurm; do sbatch "$f"; done
"""
...
DEFAULT_CLUSTER_STEM = "r09_hot_w_h2training_last100"
FRAME_START = 100
...
def remove_stale_generated_files() -> int:
    patterns = ("r09_hot_w_h2training_last100_*.inp", "r09_hot_w_h2training_last100_*.slurm")
