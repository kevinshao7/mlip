...
MD_RESULTS_DIR = os.path.join(PROJECT_ROOT, "outputsfull", "conditionsfine", "P17p7828GPa_R0p2")
...
targetmolecules = 100
moleculemass = 17.8511533333 # grams per mol, composition-weighted
...
composition_label = "R0p2"
ammonia_water_ratio = 0.2 # NH3/H2O molar ratio
...
simbox.add_solvent([water, amm], ratio=[5, 1], zdim=boxsize, density=densitygcm3)
