...
MD_RESULTS_DIR = os.path.join(PROJECT_ROOT, "outputsfull", "conditionsfine", "P17p7828GPa_R1")
...
targetmolecules = 100
moleculemass = 17.5229 # grams per mol, composition-weighted
...
composition_label = "R1"
ammonia_water_ratio = 1 # NH3/H2O molar ratio
...
simbox.add_solvent([water, amm], ratio=[1, 1], zdim=boxsize, density=densitygcm3)
