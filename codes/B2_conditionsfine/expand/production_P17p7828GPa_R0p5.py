...
MD_RESULTS_DIR = os.path.join(PROJECT_ROOT, "outputsfull", "conditionsfine", "P17p7828GPa_R0p5")
...
targetmolecules = 100
moleculemass = 17.6870266667 # grams per mol, composition-weighted
...
composition_label = "R0p5"
ammonia_water_ratio = 0.5 # NH3/H2O molar ratio
...
simbox.add_solvent([water, amm], ratio=[2, 1], zdim=boxsize, density=densitygcm3)
