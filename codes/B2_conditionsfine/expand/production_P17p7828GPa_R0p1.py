...
MD_RESULTS_DIR = os.path.join(PROJECT_ROOT, "outputsfull", "conditionsfine", "P17p7828GPa_R0p1")
...
target_profile_densitygcm3 = 1.188 # log-pressure-interpolated profile density, g/cm3
pressuregpa = 17.7827941004 # GPa
targetmolecules = 100
moleculemass = 17.9257563636 # grams per mol, composition-weighted
...
T_final = 2150  # log-pressure-interpolated preferred_uranus_temperature_K
composition_label = "R0p1"
ammonia_water_ratio = 0.1 # NH3/H2O molar ratio
...
simbox.add_solvent([water, amm], ratio=[10, 1], zdim=boxsize, density=densitygcm3)
