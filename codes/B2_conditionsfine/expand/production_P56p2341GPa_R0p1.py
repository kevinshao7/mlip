...
MD_RESULTS_DIR = os.path.join(PROJECT_ROOT, "outputsfull", "conditionsfine", "P56p2341GPa_R0p1")
...
target_profile_densitygcm3 = 2.876 # log-pressure-interpolated profile density, g/cm3
pressuregpa = 56.234132519 # GPa
targetmolecules = 100
...
T_final = 2610  # log-pressure-interpolated preferred_uranus_temperature_K
